  ...
  return (
    <div className="min-h-screen flex items-center justify-center pt-24 pb-20 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-xl mx-auto px-4 text-center">
        ...
        >
          Notre équipe répond en moins de 2 minutes. Posez vos questions, commandez ou obtenez de l&apos;aide directement par WhatsApp.
        </motion.p>
        ...
        >
          ...
          <a
            ...
            href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Bonjour, j'ai une question concernant vos offres IPTV.")}`}
            target="_blank"
