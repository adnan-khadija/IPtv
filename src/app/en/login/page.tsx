    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-[var(--color-text-primary)] mb-2">Welcome back</h1>
        ...
        <div className="card-glass p-8 rounded-2xl">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center">
              <span className="px-3 text-xs text-[var(--color-text-muted)] bg-[var(--color-bg-card)]">or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3.5 px-6 text-sm font-bold text-white rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 transition-all disabled:opacity-60 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
