...
const quickStats = [
  { icon: Tv2, label: "Channels", value: "20,000+" },
  { icon: Film, label: "VOD Titles", value: "40,000+" },
  { icon: Wifi, label: "Device", value: "1 / 1" },
  { icon: Star, label: "Plan", value: "12 Months" },
];
