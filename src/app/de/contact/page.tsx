  ...
  return (
    <div className="min-h-screen flex items-center justify-center pt-24 pb-20 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-xl mx-auto px-4 text-center">
        ...
        >
          Unser Team antwortet in unter 2 Minuten. Stellen Sie Fragen, bestellen Sie oder erhalten Sie Hilfe direkt über WhatsApp.
        </motion.p>
        ...
        >
          ...
          <a
            id="whatsapp-contact-btn-de"
            href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Hallo, ich habe eine Frage zu Ihren IPTV-Angeboten.")}`}
            target="_blank"
