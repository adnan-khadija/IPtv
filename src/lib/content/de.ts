export const contentDe = {
  ...
  faq: {
    ...
    questions: [
      {
        q: "Wie installiere ich das IPTV-Abonnement auf meinem Fernseher?",
      ...
      },
      {
        ...
        a: "Für ein flüssiges IPTV-Erlebnis in Full HD empfehlen wir eine Verbindung von mindestens 15 Mbps. Für hohe Qualität werden 30 Mbps empfohlen."
      },
      {
  ...
  sliders: {
    title: "Unsere TV-Sender & VOD",
    subtitle: "Entdecken Sie unsere große Auswahl an Live-Sendern und den neuesten Filmen & Serien.",
    live: "LIVE",
  ...
  whatsappReviews: {
    ...
    subtitle: "Was unsere zufriedenen Kunden über ihr StreamVault-Abonnement sagen.",
    agentName: "Kundensupport",
    statusOnline: "Online",
    ...
    reviews: [
      {
        ...
        avatar: "JM",
        messages: [
          { sender: "client", text: "Hallo! Ich habe meine IPTV-Zugangsdaten erhalten, vielen Dank." },
          { sender: "agent", text: "Super! Wenn Sie Fragen haben, zögern Sie nicht. Viel Spaß beim Streamen!" },
          { sender: "client", text: "Ehrlich gesagt ist die Qualität unglaublich, keine Unterbrechung beim Blue Sports-Spiel gestern Abend! Ich werde Sie meinem Vater empfehlen." },
          { sender: "agent", text: "Danke für Ihr Feedback! Das ist großartig. Genießen Sie es!" }
        ]
      },
      {
        ...
        avatar: "TD",
        messages: [
          { sender: "client", text: "Hallo, ich habe die App auf meinem Samsung Smart TV installiert, alles funktioniert einwandfrei." },
          { sender: "agent", text: "Das freut mich zu hören! Der VOD-Katalog wird automatisch aktualisiert." },
          { sender: "client", text: "Ja, habe ich gesehen. Die Liste der Netflix- und Disney+-Filme ist riesig, die Kinder sind super glücklich. Die Qualität ist echte hohe Qualität!" },
          { sender: "agent", text: "Super! Gutes Kino für die ganze Familie 🍿" }
        ]
      },
      {
        name: "Sophie L. (Neuenburg)",
        avatar: "SL",
        messages: [
          { sender: "client", text: "Guten Tag, kann ich einen 24-stündigen kostenlosen Test haben?" },
          { sender: "agent", text: "Hallo Sophie, natürlich! Hier sind Ihre Zugangsdaten: Host: http://... User: test_837 Pass: 9283" },
          { sender: "client", text: "Der 24-Stunden-Test war sehr überzeugend, ich habe gerade das 12-Monats-Abo abgeschlossen! Der Support über WhatsApp ist superschnell, gut gemacht." },
          { sender: "agent", text: "Danke Sophie! Willkommen bei StreamVault. Der Service ist nun für 1 Jahr aktiv." }
        ]
      },
      {
        name: "Laurent B. (Freiburg)",
        avatar: "LB",
        messages: [
          { sender: "client", text: "Hallo, das MAG-Portal ist konfiguriert. Alles funktioniert tadellos." },
          { sender: "agent", text: "Perfekt! Die Stabilität unseres MAG-Portals wird durch unsere redundanten Server garantiert." },
          { sender: "client", text: "Das beste IPTV, das ich je getestet habe. Null Unterbrechungen, der Programmführer (EPG) ist super umfangreich." },
          { sender: "agent", text: "Vielen Dank für Ihre Treue, Laurent!" }
        ]
      }
    ]
  },
