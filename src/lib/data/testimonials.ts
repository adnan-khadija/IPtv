...
export const testimonials: Testimonial[] = [
  {
    ...
    avatar: "MJ",
    rating: 5,
    text: "StreamVault is hands down the best IPTV service I've ever used. Crystal clear high quality streams, zero buffering, and their support team responds within minutes. Cancelled my cable subscription the same day!",
  ...
  },
  {
    ...
    avatar: "AR",
    rating: 5,
    text: "Been a subscriber for over a year now. The VOD library is incredible — thousands of movies and series. Picture quality on my Smart TV is stunning. Highly recommend the annual plan for the savings.",
    plan: "12 Month Premium",
    date: "March 2025",
  },
  {
